...
export async function prepareCodexAppRenderer({
  ...
  return createStaticRenderer({ webviewRoot, sourceAsar: archive.path, fingerprint });
}

export async function createStaticRenderer({ webviewRoot, sourceAsar = null, fingerprint = null }) {
